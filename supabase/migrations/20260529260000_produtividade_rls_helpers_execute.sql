-- =============================================================================
-- Produtividade: funções usadas em RLS precisam de EXECUTE para authenticated.
-- Erro remoto: permission denied for function fn_produtividade_can_access_actividade
-- (revogação em hardening de SECURITY DEFINER; políticas RLS também chamam estas funções).
-- =============================================================================
...
revoke all on function public.fn_produtividade_current_profile() from public, anon;
revoke all on function public.fn_produtividade_is_participante(bigint) from public, anon;
