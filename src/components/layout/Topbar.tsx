...
const routeTitles: Record<string, string> = {
  ...
  '/controlo-interno/plano-auditorias': 'Plano de Auditorias',
  '/controlo-interno/inspeccoes': 'Inspecções',
  '/controlo-interno/planeamento': 'Plano de Auditorias',
  '/controlo-interno/execucao': 'Execução de Auditorias',
  '/controlo-interno/nao-conformidades': 'Não Conformidades',
  '/controlo-interno/plano-accao': 'Plano de Acção',
  '/controlo-interno/riscos': 'Gestão de Riscos',
  '/controlo-interno/logs': 'Logs e Rastreabilidade',
  '/controlo-interno/relatorios': 'Relatórios',
