...
export function intranetNavIconForPath(path: string): React.ReactNode {
  const map: Record<string, React.ReactNode> = {
    ...
    '/portal/faltas': <CalendarX className="h-4 w-4 shrink-0" />,
    ...
    '/portal/reembolsos': <Receipt className="h-4 w-4 shrink-0" />,
    ...
    '/financas/reembolsos': <Receipt className="h-4 w-4 shrink-0" />,
    ...
    '/gestao-documentos/normativos': <Scale className="h-4 w-4 shrink-0" />,
    '/gestao-documentos/minutas': <ClipboardList className="h-4 w-4 shrink-0" />,
