...
import type { Colaborador, Ferias, Falta, ReciboSalario, Declaracao, Requisicao, CentroCusto, Projecto, Reuniao, Acta, Contrato, ProcessoJudicial, PrazoLegal, Correspondencia, DocumentoOficial, RiscoJuridico, Pagamento, PendenciaDocumental, Departamento } from '@/types';
import { COLABORADORES_SEED, FERIAS_SEED, FALTAS_SEED, RECIBOS_SEED, DECLARACOES_SEED, REQUISICOES_SEED, CENTROS_CUSTO_SEED, PROJECTOS_SEED, REUNIOES_SEED, ACTAS_SEED, CONTRATOS_SEED, PROCESSOS_SEED, PRAZOS_SEED, CORRESPONDENCIAS_SEED, DOCUMENTOS_OFICIAIS_SEED, RISCOS_SEED, PAGAMENTOS_SEED, PENDENCIAS_SEED, DEPARTAMENTOS_SEED } from '@/data/seed';
