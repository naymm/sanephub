...
export const NUMERIC_KEYS: Record<string, string[]> = {
  ...
  reembolsos: ['id', 'empresaId', 'solicitanteColaboradorId', 'montanteTotal'],
  reembolso_linhas: ['id', 'reembolsoId', 'ordem', 'montante'],
  pagamentos: ['id', 'requisicaoId', 'valor'],
  movimentos_tesouraria: ['id', 'empresaId', 'valor', 'centroCustoId', 'projectoId', 'requisicaoId', 'reembolsoId', 'contaBancariaId'],
  bancos: ['id'],
  ...
  correspondencias: ['id'],
  ci_auditorias: ['id', 'empresaId', 'auditorResponsavelColaboradorId', 'relatorioFinalTamanhoBytes'],
